 ...
 * This file demonstrates how to integrate Tokenyarn with a web frontend
 */

// For React/Vue/Angular applications
export class TokenyarnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TokenyarnClient(provider, contractAddress);
